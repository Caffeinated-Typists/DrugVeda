...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'dad3bf71-ab0e-11ed-8ee8-f23c932ad393:1-180';
...
CREATE TABLE `brands` (
  ...
  UNIQUE KEY `uq_brands_phone` (`Phone`),
...
--
-- Dumping events for database 'DrugVeda'
--

--
-- Dumping routines for database 'DrugVeda'
--
...
-- Dump completed on 2023-02-17 12:56:10
